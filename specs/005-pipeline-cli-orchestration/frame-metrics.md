...
- **FR-011**: The pipeline retains global counters for received frames, frames
  submitted for sending, successful inference frames, and failed inference
  frames.
...
- Beginning a new pipeline run makes all four counters report zero before the
